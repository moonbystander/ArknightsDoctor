...
public class IntolerableHungerPower extends AbstractPower {
    public static String POWER_ID = DoctorHelper.MakePath("IntolerableHungerPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    private static final String NAME = powerStrings.NAME;
    private static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    public IntolerableHungerPower(AbstractCreature owner,int amount){
        this.owner=owner;
        this.amount=amount;
        this.ID=POWER_ID;
        this.name=NAME;
